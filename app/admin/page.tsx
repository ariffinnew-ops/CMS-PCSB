                ...
                <table className="w-full border-collapse" style={{ minWidth: `${192 + daysCount * 26}px` }}>
                  ...
                  <thead className="sticky top-0 z-30">
                    <tr className="bg-slate-100">
                      <th className="px-2 py-1 text-left sticky left-0 z-40 border-r border-gray-300" style={{ backgroundColor: "#1e3a8a" }}>
                        <div className="flex items-center justify-between gap-1.5">
                          <div className="flex items-center gap-1.5 min-w-0">
                            ...
                            <span className="text-[9px] font-black text-white uppercase tracking-wider whitespace-nowrap">ROSTER</span>
