...
import { getRosterData, updateRosterRow } from "@/lib/actions";
        ...
        <div className="bg-card/50 backdrop-blur-md p-2 border-b border-border flex items-center gap-4 flex-shrink-0 shadow-sm">
          <div className="flex items-center gap-3 flex-grow px-4">
            ...
            <input
              ...
              className="flex-grow h-1.5 bg-muted rounded-full appearance-none cursor-pointer accent-slate-900 hover:accent-slate-700 transition-all"
            />
                                  ...
                                  {rotationIdx < 24 &&
                                    ...
                                    !!mVal && (
                                      <button
                                        ...
                                        className="w-10 h-10 rounded-full bg-slate-900 text-white flex items-center justify-center font-black text-xl hover:bg-slate-700 shadow-lg transition-all mx-2"
                                      >
                                        +
                                      </button>
                                    )}
